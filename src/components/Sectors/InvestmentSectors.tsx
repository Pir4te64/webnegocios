...
const InvestmentSectors: React.FC = () => (
    <div className="sectors-section">
        ...
        <h3>Real Estate</h3>
        <p>Investing in prime residential, commercial, and mixed-use developments in key global locations. Our real estate projects include:</p>
        <ul>
        ...
        <p>We invest in world-class hotels and resorts, catering to the growing demand for premium travel and tourism experiences. Our portfolio includes:</p>
        <ul>
        ...
        <p>Partnering with visionary entrepreneurs and established brands in the hospitality industry. Our investments include:</p>
        <ul>
        ...
        <p>We identify and invest in high-value resources, ensuring ethical sourcing and sustainable profitability. Areas of focus include:</p>
        <ul>
        ...
        <p>Supporting breakthrough technological advancements and scalable digital businesses. Our investments focus on:</p>
        <ul>
